        ...
        <div class="am-u-md-8 am-u-sm-12">
            ...
            <div class="am-g blog-article-widget blog-article-margin">
                <div class="am-u-lg-6 am-u-md-7 am-u-sm-9 am-u-sm-centered blog-text-center">
                    ...
                    <hr>
					<p>本文链接为：<?php echo $this->permalink ?>，本站使用<a href="https://creativecommons.org/licenses/by/4.0/deed.zh">「署名 4.0 国际」创作共享协议</a>，可自由转载、引用。但请署名作者且注明文章出处，谢谢。</p>
            ...
            <div class="am-g blog-author blog-article-margin">
                <div class="am-u-sm-3 am-u-md-3 am-u-lg-2">
                    <img src="<?php $this->options->avatarUrl ? $this->options->avatarUrl : $this->options->themeUrl('public/images/avatar.jpg'); ?>" alt="" class="blog-author-img am-circle">
                </div>
